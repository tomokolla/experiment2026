...
function inst_1RoutineBegin(snapshot) {
  return async function () {
    ...
    inst_1Components.forEach( function(thisComponent) {
...
function inst_3RoutineBegin(snapshot) {
  return async function () {
    ...
    inst_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inst_mailRoutineBegin(snapshot) {
  return async function () {
    ...
    inst_mailComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inst_ageRoutineBegin(snapshot) {
  return async function () {
    ...
    inst_ageComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inst_sexRoutineBegin(snapshot) {
  return async function () {
    ...
    inst_sexComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inst_setumei_1RoutineBegin(snapshot) {
  return async function () {
    ...
    inst_setumei_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inst_setumei_2RoutineBegin(snapshot) {
  return async function () {
    ...
    inst_setumei_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inst_gakusyuRoutineBegin(snapshot) {
  return async function () {
    ...
    inst_gakusyuComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function trial_mainRoutineBegin(snapshot) {
  return async function () {
    ...
    trial_mainComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inst_JOLRoutineBegin(snapshot) {
  return async function () {
    ...
    inst_JOLComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function jol_ratingRoutineBegin(snapshot) {
  return async function () {
    ...
    jol_ratingComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inst_keisanRoutineBegin(snapshot) {
  return async function () {
    ...
    inst_keisanComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function Keisan_newRoutineBegin(snapshot) {
  return async function () {
    ...
    Keisan_newComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inst_testRoutineBegin(snapshot) {
  return async function () {
    ...
    inst_testComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function inst_URLRoutineBegin(snapshot) {
  return async function () {
    ...
    inst_URLComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
